...
#
# Script generated by Vivado on Sun Sep 29 18:08:32 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : square_float.sh
...
#
# Usage        : square_float.sh
#                square_float.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                square_float.sh [-reset_run]
#                square_float.sh [-reset_log]
#                square_float.sh [-help]
#
...
#                script (type 'square_float.sh -help' for more information).
#
...
# script info
echo -e "square_float.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./square_float.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.square_float xil_defaultlib.glbl -o square_float_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./square_float_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key square_float_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc square_float_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./square_float.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: square_float.sh [-help]\n\
Usage: square_float.sh [-step]\n\
Usage: square_float.sh [-lib_map_path]\n\
Usage: square_float.sh [-reset_run]\n\
Usage: square_float.sh [-reset_log]\n\
Usage: square_float.sh [-keep_index]\n\
Usage: square_float.sh [-noclean_files]\n\n\
