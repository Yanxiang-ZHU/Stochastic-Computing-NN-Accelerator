...
#
# Script generated by Vivado on Thu Feb 27 20:31:25 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bram_fcweight.sh
...
#
# Usage        : bram_fcweight.sh
#                bram_fcweight.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_fcweight.sh [-reset_run]
#                bram_fcweight.sh [-reset_log]
#                bram_fcweight.sh [-help]
#
...
#                script (type 'bram_fcweight.sh -help' for more information).
#
...
# script info
echo -e "bram_fcweight.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_fcweight.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bram_fcweight xil_defaultlib.glbl -o bram_fcweight_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bram_fcweight_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bram_fcweight_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bram_fcweight_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_fcweight.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_fcweight.sh [-help]\n\
Usage: bram_fcweight.sh [-step]\n\
Usage: bram_fcweight.sh [-lib_map_path]\n\
Usage: bram_fcweight.sh [-reset_run]\n\
Usage: bram_fcweight.sh [-reset_log]\n\
Usage: bram_fcweight.sh [-keep_index]\n\
Usage: bram_fcweight.sh [-noclean_files]\n\n\
