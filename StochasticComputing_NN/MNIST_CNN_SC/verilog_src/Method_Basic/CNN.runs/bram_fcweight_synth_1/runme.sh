...
HD_PWD='C:/Users/39551/Desktop/Stochastic_Computing/CNN/CNN.runs/bram_fcweight_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_fcweight.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_fcweight.tcl
