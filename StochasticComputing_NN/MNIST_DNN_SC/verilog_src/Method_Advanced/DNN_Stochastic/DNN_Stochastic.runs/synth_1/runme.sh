...
HD_PWD='C:/Users/39551/Desktop/Stochastic-Computing-for-MNIST/DNN-like Structure/DNN_Stochastic/DNN_Stochastic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DNN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DNN.tcl
