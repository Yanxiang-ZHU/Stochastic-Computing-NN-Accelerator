...
HD_PWD='C:/Users/39551/Desktop/Stochastic-Computing-for-MNIST/DNN-like Structure/DNN_Stochastic/DNN_Stochastic.runs/weight_fc2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weight_fc2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weight_fc2.tcl
