...
HD_PWD='C:/Users/39551/Desktop/Stochastic_Computing/KERNEL_binary/KERNEL_binary.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kernel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kernel.tcl
