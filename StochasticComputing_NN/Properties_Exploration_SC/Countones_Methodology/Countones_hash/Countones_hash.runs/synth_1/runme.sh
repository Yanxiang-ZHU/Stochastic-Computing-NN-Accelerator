...
HD_PWD='C:/Users/39551/Desktop/Stochastic_Computing/Countones_hash/Countones_hash.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hash.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hash.tcl
