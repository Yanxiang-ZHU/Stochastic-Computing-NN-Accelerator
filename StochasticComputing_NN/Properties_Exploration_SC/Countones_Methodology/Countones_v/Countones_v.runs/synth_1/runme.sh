...
HD_PWD='C:/Users/39551/Desktop/Stochastic_Computing/Countones_v/Countones_v.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CountOnes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CountOnes.tcl
