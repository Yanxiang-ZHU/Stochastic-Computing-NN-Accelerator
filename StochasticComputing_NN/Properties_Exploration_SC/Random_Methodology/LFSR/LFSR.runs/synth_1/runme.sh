...
HD_PWD='C:/Users/39551/Desktop/Stochastic Computing/LFSR/LFSR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LSFR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LSFR.tcl
