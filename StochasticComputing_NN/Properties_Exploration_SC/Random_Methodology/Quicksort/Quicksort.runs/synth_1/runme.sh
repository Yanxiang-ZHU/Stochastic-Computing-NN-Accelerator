...
HD_PWD='C:/Users/39551/Desktop/Stochastic_Computing/Quicksort/Quicksort.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Quicksort.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Quicksort.tcl
