...
HD_PWD='C:/Users/39551/Desktop/Stochastic_Computing/SOBOL/SOBOL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sobol_random.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sobol_random.tcl
